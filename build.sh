...
export ANT_HOME=../divcon-support_libs/apache-ant-1.8.2
...
../divcon-support_libs/apache-ant-1.8.2/bin/ant clean
../divcon-support_libs/apache-ant-1.8.2/bin/ant jar
