...
export PROJECT_PATH=/home/roger/DivConDiscoverySuite-b2566
...
export SVL_JVM=$PROJECT_PATH/linux-x86_64/java/bin/java
...
#qbmoebatch -licwait -exec "qbTesth5Main['/home/roger/testing-grounds/Josh/s59/s59.pm6.sp.xml.h5']" -exit
qbmoebatch -licwait -exec "qbTesth5Main['/home/roger/testing-grounds/Josh/1LRI/test/1LRId_out.h5']" -exit
#qbmoebatch -licwait -exec "qbTestPDBtoH5['./roothaan.h5', '/home/roger/NetBeansProjects/OOBackbone/tests/examples/3FVA.pdb']" -exit
#qbmoe -licwait -exec "ReadHDF5['/home/lance/RajDupnt/SecondRun/PWD/roothaan.h5']"
